...
namespace Banco
{
    public partial class frmPrincipal : Form
    {
        ...
        private Dictionary<string, Conta> dicionarioTitularConta = new Dictionary<string, Conta>();
        ...
        public void AdicionaConta(Conta c)
        {
            ...
            // Adiciona a conta no dicionário, para utilizar no metodo de busca
            this.dicionarioTitularConta.Add(c.Titular.Nome, c);
        }
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            //    //Se não encontrar a chave será retornado <<null>>
            //    Conta conta = dicionarioTitularConta[nomeTitular];
            //    //Aqui haverá erro porque não é possível inserir <<null>> no comboBox.
            //    cmbContas.SelectedItem = conta;
            //}
            //catch (KeyNotFoundException)
            //{
            //    MessageBox.Show("Titular não cadastrado"); ;
            //}

            string nomeTitular = txtBuscaTitular.Text;
            Conta conta;
            bool EncontrouTitular = dicionarioTitularConta.TryGetValue(nomeTitular, out conta);

            if (EncontrouTitular == true)
            {
                cmbContas.SelectedItem = conta;
            }
            else
        ...
        {
            frmRelatorios formularioRelatorios = new frmRelatorios(this, contas);
